...
const navigate = useNavigate()
  ...
  <div className="item__planner__data item--1__planner__data">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M7 10l5 5 5-5H7z" fill="rgba(149,149,255,1)"></path></svg>
  ...
  <div className="item__planner__data item--2__planner__data">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M7 10l5 5 5-5H7z" fill="rgba(252,161,71,1)"></path></svg>
  ...
  <div className="item__planner__data item--3__planner__data">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 10l5 5 5-5H12z" fill="rgba(66,193,110,1)"></path></svg>
  ...
  <div className="item__planner__data item--4__planner__data">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 14l5 5 5-5H12z" fill="rgba(220,91,183,1)"></path></svg>
