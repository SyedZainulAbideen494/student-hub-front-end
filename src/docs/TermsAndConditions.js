...
const TermsAndConditions = () => {
    return (
        <div className="policy__page">
            ...
            <p className="content__policy__page">
                6. By subscribing to any of our premium plans (₹39/week, ₹99/month, ₹499/6 months), you acknowledge that the subscription is non-refundable. No refunds will be issued for any payments made, regardless of usage or cancellation. 
            </p>
            <p className="content__policy__page">
                7. In the event that the app is down for any period of time (e.g., an hour or a day), we will not compensate users for any inconvenience caused. While we strive to provide continuous service, occasional downtime may occur due to maintenance or unforeseen issues.
            </p>

            <h2 className="subheading__policy__page">Acceptance of Related Policies</h2>
            <p className="content__policy__page">
                8. By agreeing to these Terms, you also acknowledge and accept our <Link to="/privacy-policy">Privacy Policy</Link> and <Link to="/more-info">More Information</Link>. These documents provide detailed information on how we handle your data, your rights as a user, and additional guidelines for using Edusify.
            </p>

            <h2 className="subheading__policy__page">Prohibited Activities</h2>
            <p className="content__policy__page">
                9. You agree not to engage in activities that:
            </p>
            ...
            <p className="content__policy__page">
                10. We reserve the right to suspend or terminate your account at our discretion for violations of these Terms or any other reason deemed necessary to protect the integrity of Edusify and its community.
            </p>

            <h2 className="subheading__policy__page">Limitation of Liability</h2>
            <p className="content__policy__page">
                11. Edusify is provided on an "as-is" basis. While we strive to ensure the app functions smoothly, we do not guarantee uninterrupted or error-free service. We are not liable for any damages arising from the use or inability to use the app.
            </p>

            <h2 className="subheading__policy__page">Changes to Terms</h2>
            <p className="content__policy__page">
                12. Edusify reserves the right to modify these Terms at any time. Any changes will be communicated via updates within the app or notifications sent to your registered email. Continued use of the app after changes have been made constitutes your acceptance of the updated Terms.
            </p>

            <h2 className="subheading__policy__page">Contact Us</h2>
            <p className="content__policy__page">
                13. If you have any questions or concerns regarding these Terms or any aspect of Edusify, please reach out to us through our support channels.
            </p>
