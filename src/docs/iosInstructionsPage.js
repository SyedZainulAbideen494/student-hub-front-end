...
import './IOSInstructions.css'; // Create this CSS file for styling

const IOSInstructions = () => {
  return (
    <div className="instructions-container__ios__instructions">
      <h1 className="title__ios__instructions">We're Working on Our iOS App!</h1>
      <p className="intro__ios__instructions">While we’re perfecting the iOS app, you can still add Edusify to your home screen as a shortcut for quick access. Follow the steps below:</p>
      ...
      <div className="steps__ios__instructions">
        <div className="step__ios__instructions">
          ...
          <p className="step-description__ios__instructions">Open Safari and navigate to our <a href='https://edusify.vercel.app' target="_blank" rel="noopener noreferrer">web app</a>.</p>
        </div>
        <div className="step__ios__instructions">
