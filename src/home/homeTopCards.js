    ...
    useEffect(() => {
        ...
        const scheduleReminder = () => {
          const intervalId = setInterval(() => {
            ...
            const reminders = [
              ...
              { hour: 23, minute: 34, message: "It's 11:30 PM! Take a break and relax!" },  // New reminder for 11:30 PM
            ];
        ...
        const showNotification = (message) => {
          if (Notification.permission === 'granted') {
            ...
            // Display the notification without actions
        ...
        // Request notification permission and set up reminder schedule
